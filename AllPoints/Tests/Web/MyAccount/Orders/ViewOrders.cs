...
{
    [TestClass]
    public class ViewOrders : AllPointsBaseTest
    {
        #region View
        ...
        public void SearchByWebReference()
        {
            ...
            //Changed by: Carlos acosta
            //Comments: Gus told me that "IsAppBussy is deprecated and told me to delete it, the method no longer exists
            //bool filterTimeout = ordersPage.IsAppBussy();
